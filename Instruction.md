...
Для получения информации о процессорах необходимо использовать протокол MP_SERVICE протокол, функции которого находятся в библиотеке `Protocol/MpService.h`. У протокола есть зависимость `PiDxe.h`.
